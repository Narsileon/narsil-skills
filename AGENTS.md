...
| `skills/react/` | React — [SKILL.md](skills/react/SKILL.md) |
| `skills/typo3/` | TYPO3 — [SKILL.md](skills/typo3/SKILL.md) (imports [php](skills/php/SKILL.md)) |
...
Pick the stack links that apply (e.g. Laravel projects: `php` + `laravel`; TYPO3 projects: `php` + `typo3`).
